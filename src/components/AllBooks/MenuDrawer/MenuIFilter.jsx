...
import {Box, Button, Divider, Drawer, IconButton, List, ListItem, styled, useTheme} from "@mui/material";
    ...
    return (
        <React.Fragment>
            <Button
                ...
                variant="text"
                sx={{ mr: 2, ...(open && { display: 'none' }), display: {lg: 'none', xs: 'flex', md: 'none'} }}
            >Filtrar por:
            </Button>
            <Drawer
                variant="persistent"
            ...
            >
                <DrawerHeader>
                    <IconButton onClick={handleDrawerClose}>
                        {themeUI.direction === 'ltr' ? <ChevronLeftIcon /> : <ChevronRightIcon />}
                    </IconButton>
                </DrawerHeader>
                <Divider />
                <List>
